...
interface DetailedProfileContainerProps {
  userId: string;
}

export function DetailedProfileContainer({ userId }: DetailedProfileContainerProps) {
  ...
  const handleFollowingPress = useCallback(() => {
    ...
    router.push(`/(screens)/(following)/${userId}` as any);
  ...
  const handleFollowersPress = useCallback(() => {
    ...
    router.push(`/(screens)/(followers)/${userId}` as any);
