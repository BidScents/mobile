...
import { usePendingAuctions } from '@/hooks/queries/use-dashboard';
...
export default function PendingView() {
  ...
  const {data, isLoading, isFetchingNextPage, hasNextPage, fetchNextPage, refetch, isRefetching, error} = usePendingAuctions();
    ...
    return (
      <View flex={1} justifyContent="center" alignItems="center" paddingHorizontal="$6">
        ...
        <Text fontSize="$4" color="$mutedForeground" textAlign="center" marginBottom="$4">
          We couldn&apos;t load your pending auctions. Please try again.
        </Text>
  ...
  if (!flatListings || flatListings.length === 0) {
    return (
      <View flex={1} justifyContent="center" alignItems="center" paddingHorizontal="$6">
        ...
        <Text fontSize="$4" color="$mutedForeground" textAlign="center" marginBottom="$4">
          You don&apos;t have any pending auctions waiting for settlement.
        </Text>
      </View>
    );
  }
