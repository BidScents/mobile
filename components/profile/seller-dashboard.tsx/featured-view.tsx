...
export default function FeaturedView({ 
  ...
  const {data, isLoading, isFetchingNextPage, hasNextPage, fetchNextPage, refetch, isRefetching, error} = useFeaturedListings();
    ...
    return (
      <View flex={1} justifyContent="center" alignItems="center" paddingHorizontal="$6">
        ...
        <Text fontSize="$4" color="$mutedForeground" textAlign="center" marginBottom="$4">
          We couldn&apos;t load your featured listings. Please try again.
        </Text>
  ...
  if (!flatListings || flatListings.length === 0) {
    return (
      <View flex={1} justifyContent="center" alignItems="center" paddingHorizontal="$6">
        ...
        <Text fontSize="$4" color="$mutedForeground" textAlign="center" marginBottom="$4">
          You don&apos;t have any featured listings yet. Go to your active listings select it and tap the boost button.
        </Text>
      </View>
    );
  }
